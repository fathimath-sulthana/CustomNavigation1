...
const TabArr = [
  ...
  { route: 'Search', label: 'Search', type: Icons.Feather, icon: 'search', component: Search, color: Colors.green, alphaClr: Colors.greenAlpha },
  { route: 'Add', label: 'Add New', type: Icons.Feather, icon: 'plus-square', component: Add, color: Colors.red, alphaClr: Colors.redAlpha },
  { route: 'Account', label: 'Account', type: Icons.FontAwesome, icon: 'user-circle-o', component: Account, color: Colors.purple, alphaClr: Colors.purpleAlpha },
];
...
export default function TabNav2() {
  return (
    <Tab.Navigator
      screenOptions={{
        headerShown: false,
