...
import TabNav1 from "../../Tab/screens/TabNav1";
import TabNav from "../../Tab/screens/TabNav";
import TabNav2 from "../../Tab/screens/TabNav2";
export const ScreensArray = [
  { route: 'Tab', label: 'Home', type: Icons.Feather, icon: 'home', component: TabNav, notification: 0, },
  { route: 'Tab1', label: 'My Inbox', type: Icons.Feather, icon: 'inbox', component:TabNav1 , notification: 9, },
  { route: 'Tab2', label: 'My Calendar', type: Icons.Feather, icon: 'calendar', component: TabNav2, notification: 4, },
